...
COPY extract-lys-preview.js extract-f3d-preview.js parse-lys-geometry.js step-assembly.js ./
COPY vendor/ ./vendor/
COPY favicon.ico ./
COPY *.png *.jpg *.bmp ./
COPY guide/ ./guide/
